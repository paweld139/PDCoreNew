...
namespace PDCoreNew.Extensions
{
    ...
    public static partial class CompresExtension
    {
        ...
        {
            using MemoryStream input = new(bytesToEncode); //Utworzenie strumienia pamięci na podstawie przekazanej tablicy bajtów

            using MemoryStream output = new(); //Utworzenie nowego strumienia danych (zostanie zniszczony po zakończeniu wywoływania kodu w obrębie bloku "using")
        ...
        {
            using MemoryStream input = new(compressedBytes); //Utworzenie strumienia pamięci na podstawie przekazanej tablicy bajtów
