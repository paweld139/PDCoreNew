...
namespace PDCoreNew.Extensions
{
    public static class StringExtensions
    {
        ...
        public static T ToEnumValue<T>(this string enumerationDescription) where T : struct
        {
            ...
            throw new ArgumentException("ToEnumValue<T>(): Invalid description for enum " + type.Name, nameof(enumerationDescription));
        }
        ...
        {
            return $"{value.First().ToString().ToLowerInvariant()}{value[1..]}";
        }
