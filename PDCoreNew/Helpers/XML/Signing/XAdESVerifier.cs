...
namespace PDCoreNew.Helpers.XML.Signing
{
    ...
    {
        private static readonly Regex pattern = new("_(.+?)_", RegexOptions.Compiled);
        ...
        public void CheckRoot(string thumbprint)
        {
            ...
            if (
                StringComparer.OrdinalIgnoreCase.Compare(chain.ChainElements[^1].Certificate.Thumbprint,
                                                         thumbprint) != 0)
            {
