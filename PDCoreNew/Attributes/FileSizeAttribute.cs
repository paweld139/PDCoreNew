...
namespace PDCoreNew.Attributes
{
    ...
    public sealed class FileSizeAttribute : ValidationAttribute
    {
        ...
        public FileSizeAttribute(int maximumSize) : base(() => ErrorMessages.FileSizeAttribute_ValidationError)
        {
        ...
        public override string FormatErrorMessage(string name)
        {
            ...
            string errorMessage = MinimumSize != 0 ? ErrorMessages.FileSizeAttribute_ValidationErrorIncludingMinimum : ErrorMessageString;
        ...
        private void EnsureLegalSizes()
        {
            if (MaximumSize < 0)
            {
                throw new InvalidOperationException(ErrorMessages.FileSizeAttribute_InvalidMaxSize);
            }

            if (MaximumSize < MinimumSize)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, ErrorMessages.RangeAttribute_MinGreaterThanMax, MaximumSize, MinimumSize));
            }
        }
    }
}
